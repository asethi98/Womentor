...
public class MainActivity extends Activity {
    ...
    public void getOtherUsers() {
        DatabaseReference otherTypeDb = FirebaseDatabase.getInstance().getReference().child("Users").child(otherUserType);
        otherTypeDb.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
